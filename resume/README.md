...
The project needs to be hosted using any Web-Server like `apache`, `tomcat`, `http-server` or `SimpleHTTPServer` etc. I use `xamp` as it has all web related servers like `apache`, `tomcat` etc.
...
To clone
```bash
$ git clone https://github.com/lucifer47C/The-Cloud-Resume-Challenge.git
```
